...
describe('Sulfuras, Hand of Ragnaros', () => {
  describe('(0,80) - Regular ', () => {
    it('should have sell_in 0 on day 1', () => {
...
describe('TAFKAL80ETC', () => {    
  describe('(15, 20) - Normal', () => {
    ...
    it('should have quality 21 on day 1', () => {
  ...
  describe('(11,0) - quality +2 when day <= 10', () => {
    it('should have sell_in 10 on day 1', () => {
  ...
  describe('(6,0) - quality +3 when day <= 5', () => {
    it('should have sell_in 5 on day 1', () => {
  ...
  // Date Passes
  describe('(0,50) - past concert ', () => {
    it('should have sell_in -1 on day 1', () => {
      assert.strictEqual(items[9].sell_in, -1, 'Failed');
    });
    it('should have quality 0 on day 1', () => {
